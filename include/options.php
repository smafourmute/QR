            ...
            <div class="col-sm-12 mb-2 custom-background">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="custom-control form-check form-switch mt-2">
                        ...
                        <div class="custom-control form-check form-switch mb-2">
                        ...
                        <div class="collapse" id="collapse-image-bg">
                            ...
                            <div class="custom-control form-check form-switch d-none negative-code">
